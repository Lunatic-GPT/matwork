function res=sROT_MATRIX(orient,deg)
% The sROT_MATRIX used in sequence event blocks
...
%deg: inplane rotation in degrees;
% not complete for oblique orientations
