function [] = writeanalyze(data,orient,varargin)
...
DEFAULT_SCALING = 'auto';  % Note: this variable is included to work with
...
if ~isstr(data)
  ...
  if length(isize) == 3
    ...
    % Write header file
    writeheaderfile(filename,isize,vsize,dtype,DEFAULT_SCALING,orient,scl);
    
    % Open img file
    fid = fopen([filename,'.img'],'w','b');
    if fid < 0
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
function [] = writeheaderfile(filename,isize,vsize,dtype,scaling,orient,spm_scl)
