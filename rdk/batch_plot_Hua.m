...
% ts Plotscd /media/Human_fMRI_backup/data/MRI/Hua/rdk_12_04_08/afni;
root = '/media/Human_fMRI_backup/data/MRI/';

p = parameter('Sort and plot average time series in roi');
p = add(p,'filename','stimulus file',fullfile(root,'Hua/rdk_12_04_08/afni/stim/stim_cohall.1D'));
...
p_ts = p;
 ...
 %hMT_glm
 mstr = 'mask_glm_REML_tall+orig;equals(a,1)+equals(a,3)';
run_tsroi_arearoi_sortave(p_a,p_ts,mstr,'hMT_glm');
% ST
mstr = 'mask_glm_REML_tall+orig;equals(a,2)';
