...
%         
%         if mod(nxk,2)==0
%          ind2=p(2)-nxk/2:p(2)+nxk/2-1;
%         else
%          ind2=p(2)-(nxk-1)/2:p(2)+(nxk-1)/2;  
%         end
%        
%         if mod(nyk,2)==0
%          ind1=p(1)-nyk/2:p(1)+nyk/2-1;
%         else
%          ind1=p(1)-(nyk-1)/2:p(1)+(nyk-1)/2;
%         end
%        
%         sel1=ind1>=1 & ind1<=nvox(1)*interp; 
%         sel2=ind2>=1 & ind2<=nvox(2)*interp;
%        
%         frtmp=res0(ind1(sel1),ind2(sel2));
%    
%         
%         sel1=ind1>=1 & ind1<=nvox(1)*interp; 
%         sel2=ind2>=1 & ind2<=nvox(2)*interp;
...
%         frtmp=res0(ind1(sel1),ind2(sel2));
%         
%         tmp=kernelx(sel1,sel2).*kernely(sel1,sel2).*frtmp;
