...
% the different processes in this function is now divided into different
% files including (1) generating mask from traces and (2) calculating the orientation and tortuosity.
