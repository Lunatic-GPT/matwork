...
% backtracking line-search
	...
	[FTXFMtx, FTXFMtdx, DXFMtx, DXFMtdx] = preobjective2(x, dx, XFM,TV,FT,TVWeight);%preobjective(x, dx, params);
	 tic;
        f0  = objective2(FTXFMtx, FTXFMtdx, DXFMtx, DXFMtdx, x,dx,0, p,data,TVWeight,xfmWeight,l1Smooth);
     
	t = t0;
        [f1, ERRobj, RMSerr,TV,XFM]  = objective2(FTXFMtx, FTXFMtdx, DXFMtx, DXFMtdx, x,dx,t, p,data,TVWeight,xfmWeight,l1Smooth);
	...
	disp(sprintf('%d   , obj: %f, RMS: %f, L-S: %d, TV: %f, XFM: %f', k,f1,RMSerr,lsiter,TV,XFM));
