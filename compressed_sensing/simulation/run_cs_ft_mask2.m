function run_cs_ft_mask2(nois,tvWeight,ftWeight,m,suffix)
...
recon=run_cs(z2,m,true,4:6,tvWeight,ftWeight);        
        ...
        prefix = sprintf('run_cs_ft_nois%4.3f_tv%4.3f_ft%4.3f%s',nois,tvWeight,ftWeight,suffix);
