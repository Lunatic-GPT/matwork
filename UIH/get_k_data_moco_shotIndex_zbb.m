function [k3,Data]=get_k_data_moco_shotIndex_zbb(Data,dfile,shotIndex,fov,ro_pe_par,ds)
...
Data = reshape(double(Data),[nro,sz(2)*sz(3),Nc]);
k2 = reshape(double(k2),[nro,sz(2)*sz(3),3]);
k3=k2(:,:,abs(ro_pe_par)); %[ro,pe,par]
