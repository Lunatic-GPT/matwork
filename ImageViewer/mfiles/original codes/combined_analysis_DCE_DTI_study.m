function combined_analysis_DCE_DTI_study(subject, number)
...
SID = subject;
    ...
    array_line = number;
    load('time_points_array_DTI_analysis.mat');
...
%     delta5 = time_points_array(array_line,5);
    shift_x = time_points_array_DTI_analysis(array_line,6); % THESE ARE THE DCE<->DTI shifts!
    shift_y = time_points_array_DTI_analysis(array_line,7);
    nslices = time_points_array_DTI_analysis(array_line,8);
    first_slice = time_points_array_DTI_analysis(array_line,9);
...
load('data_folder_DTI_analysis.mat');
...
%         user_entry_slice = input('Assign the slice number of the DCE series of interest: ');
    ...
    save_folder = [save_folder_basic '/research_results_DTI_analysis_model_set_up/slice' user_entry_slice_str];
    ...
    if slice == 1
        ...
        DCE_dir = data_folder_DTI_analysis{array_line};
...
%% For Building up of model 7/1/2008
savename = [save_folder '/ADC_vector.mat'];
save(savename, 'ADC_lesion_vec_shifted');

savename = [save_folder '/ADC_tissue_vector.mat'];
save(savename, 'ADC_tissue_vec_shifted');

savename = [save_folder '/ADC_tissue2_vector.mat'];
save(savename, 'ADC_tissue2_vec_shifted');

savename = [save_folder '/FA_vector.mat'];
save(savename, 'FA_lesion_vec_shifted');

savename = [save_folder '/FA_tissue_vector.mat'];
save(savename, 'FA_tissue_vec_shifted');

savename = [save_folder '/FA_tissue2_vector.mat'];
save(savename, 'FA_tissue2_vec_shifted');
...
%     user_entry_slice_str = num2str(user_entry_slice);
%     slicen =num2str(slice);
%     save_folder = [save_folder_basic '/research_results_detailed_1std/slice' user_entry_slice_str];
%     exist_test = exist(save_folder,'dir');
%     if exist_test == 0
%         mkdir(save_folder);
%     end
% 
%     s1 = ['/research_results_detailed_1std/slice' user_entry_slice_str];
%     temp_dir = [dir_name s1];
%     
%     last_slice = first_slice+nslices-1;
%     last_slice_str = num2str(last_slice);
%     s1 = ['/research_results_detailed_1std/slice' last_slice_str];
