function combined_analysis(subject, number)
...
%     delta5 = time_points_array(array_line,5);
    shift_x = time_points_array(array_line,6);
...
%         user_entry_slice = input('Assign the slice number of the DCE series of interest: ');
    ...
    save_folder = [save_folder_basic '/research_results/slice' user_entry_slice_str];
...
savename = [save_folder '/analysis_results2.mat'];
...
%         %% END RAW VALUES CALCULATION FOR TIME_SERIES
   ...
   elseif user_entry_slice == 3
    ...
    if flag1 == 1 && flag2 == 1 && flag3 == 1
        lesion_vol = results_copy{1} + results_copy{2} + results_copy{3};
    elseif flag1 == 1 && flag2 == 1
        lesion_vol = results_copy{1} + results_copy{2};
    elseif flag2 == 1 && flag3 == 1
        lesion_vol = results_copy{1} + results_copy{2};
    else
        lesion_vol = results_copy{1};
    end
