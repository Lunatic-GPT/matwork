...
% [Z, Xcluster, A, cluster] = isodata_ND(X, k, L, I, ON, OC, OS, NO,
% min_dist)
% ----------------------------------------------------------
% Input parameters
%X: N*d array. with N nodes and d dimensions.
...
%min_dist=50; %Minimum distance a point must be in each center. If you want to remove any item not give a high value. 
%-----------------------------------------------------------
% output parameters
% A, number of cluseters.
% cluseter: same size as X, contains indices of the clusters each element
% belongs to
% Xcluster: a cell array containing all the clusters
% Z: center positions of the clusters
