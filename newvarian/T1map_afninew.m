function T1map_afninew(fid_prefix,ind_ex,stretch_exp)
    ...
    for j=1:size(a,2)
        for k=1:size(a,3)
            ...
            if ~stretch_exp
              ...
              [beta,r]=lsqcurvefit(@T1_rcvr_abs,[max(y),2,1],te2(:),y(:),[],[],options);
               beta(4)=1;
            else
...
if ~stretch_exp
   ...
   name = ['R1mapStretch_abs_',fid_prefix];
end
