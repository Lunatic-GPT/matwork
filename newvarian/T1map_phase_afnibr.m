function T1map_phase_afnibr(fid_prefix,ind_ex)
...
b=BrikLoad([fid_prefix,'_reconph+orig']);

d=a.*exp(1i*b);

te2=readbPar(fullfile(fid_prefix,'method'),'TIxp');
