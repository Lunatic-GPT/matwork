...
/************************************************************************** MEX Routine 
 * grid_volume = grid3_MAT_xp(0:data, 1:crds, 2:weights, 3:effMtx) 
 * 
 * REQUIRED:
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    const char help_txt[] = "USAGE: (see grid3_MAT_xp.c) \n\
 * grid_volume = grid3_MAT(0:data, 1:crds, 2:weights, 3:effMtx) \n\
 * \n\
 * REQUIRED: \n\
 *  data: N-D double-precision matrix >=2D, fastest varying dimension is length 2 \n\
 * \n\
 ...
 * \n";
    ...
    */
    ...
    {
        printf("%s",help_txt);
        mexErrMsgTxt("3 required inputs are: data,coords, weights, effMtx.");
    }
